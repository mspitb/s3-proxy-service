...
s3_api_service = S3APIService()
MAX_UPLOAD_SIZE: str = os.getenv("MAX_UPLOAD_FILE_SIZE_MB")
...
async def upload_file(file: UploadFile = File(...),
    ...
    try:
        ...
        if file.size.real / 1024 > int(MAX_UPLOAD_SIZE):
            raise ValueError(f"Upload file size can't be more then {MAX_UPLOAD_SIZE}.")
