...
class TestBaseRequest(unittest.TestCase):
    BUCKET_NAME_ERROR_MESSAGE: str = "Incorrect value provided for bucket name. Please, verify minio bucket name rules."
    OBJECT_NAME_ERROR_MESSAGE: str = "Incorrect value provided for object name. Please, verify minio bucket name rules."
    ...
    def test_bucket_name_is_empty(self):
        ...
        self.assertEqual(self.BUCKET_NAME_ERROR_MESSAGE, str(context.exception.get_message()))
    ...
    def test_bucket_name_valid(self):
        try:
            ...
            self.fail("S3ProxyServiceException raised unexpectedly for a valid bucket name!")
    ...
    def test_object_name_is_empty(self):
        ...
        self.assertEqual(self.OBJECT_NAME_ERROR_MESSAGE, str(context.exception.get_message()))
