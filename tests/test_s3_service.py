...
class TestS3Service(unittest.TestCase):
    ...
    def test_download_file_http_exception(self, minio_client_init):
        ...
        mock_minio_client.get_object.side_effect = HTTPError(
            "url", 404, "exception", MagicMock(spec=Message), None
        )
        try:
    ...
    def test_upload_file_bucket_must_be_created(self, minio_client_init):
        ...
        mock_minio_client.make_bucket.assert_called_once_with(
            bucket_name="bucket-name", object_lock=True
        )
